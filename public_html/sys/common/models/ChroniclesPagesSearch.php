...
/**
 * ChroniclesPagesSearch represents the model behind the search form of `common\models\ChroniclesPages`.
 */
class ChroniclesPagesSearch extends ChroniclesPages
{
    /**
     * {@inheritdoc}
     */
