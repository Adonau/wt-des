...
/* @var $searchModel common\models\DatePagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Страницы с датами';
?>
<ul class="breadcrumb">
    <li>
...
<div class="flex-column page date-pages-index">
    ...
    <p>
        <?= Html::a('Создать страницу с датами', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
