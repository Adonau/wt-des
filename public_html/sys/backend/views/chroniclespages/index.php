...
/* @var $searchModel common\models\ChroniclesPagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Страницы с Хрониками';
?>
<ul class="breadcrumb">
    <li>
...
<div class="flex-column page chronicles-pages-index">
    ...
    <p>
        <?= Html::a('Создать страницу с хрониками', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
