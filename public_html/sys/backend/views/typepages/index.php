...
/* @var $searchModel common\models\TypePagesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Страницы с типами';
?>
<ul class="breadcrumb">
    <li>
...
<div class="flex-column page type-pages-index">
    ...
    <p>
        <?= Html::a('Создать страницу с типами', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
